...
//
//import com.kurlabo.backend.service.CustomUserDetailsService;
...
//        this.secret = secret;
//        this.tokenValiditySeconds = tokenValiditySeconds * 1000;
...
//        Date validity = new Date(now + this.tokenValiditySeconds);
//
//        return Jwts.builder()
