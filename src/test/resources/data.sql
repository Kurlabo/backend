-- Board
insert into board (board_id, cnt, content, regdate, title, writer)
values(
          1,
          7093,
...
-- Main_Src
insert into main_src(main_src_id, setbyul_img) values (1, 'https://img-cf.kurly.com/shop/data/main/15/pc_img_1568875999.png');
